...
import { IconBook, IconTrash, IconX } from '@tabler/icons-preact';
  ...
  return (
    <Fragment>
      ...
      <div
        ...
        style={{ zIndex: 1000000 }} // Ensure toggle button is also high
      ...
      <section
        data-theme={currentTheme.value}
        style={{ zIndex: 1000000 }} // Ensure it's above everything
        class={cx(
