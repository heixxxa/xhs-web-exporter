...
![02-export-media.png](https://github.com/heixxxa/xhs-web-exporter/raw/main/docs/02-export-media.png)
...
**问：脚本抓取不到任何数据！** <br>
答：参见 [Content-Security-Policy (CSP) Issues #19](https://github.com/heixxxa/xhs-web-exporter/issues/19)。
...
**问：脚本无法运行！** <br>
答：平台升级可能会导致脚本功能故障。如果遇到任何问题，请提交 [issue](https://github.com/heixxxa/xhs-web-exporter/issues) 反馈。
